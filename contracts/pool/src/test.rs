...
fn setup_test_env() -> (Env, Address, Address, Address, Address, Address, Address) {
    ...
    // Initialize pool
    pool_client.initialize(&admin, &oracle, &xlm_token, &usdc_token);
...
fn test_initialize() {
    ...
    client.initialize(&admin, &oracle, &xlm_token, &usdc_token);
...
fn test_initialize_twice() {
    ...
    client.initialize(&admin, &oracle, &xlm_token, &usdc_token);
    client.initialize(&admin, &oracle, &xlm_token, &usdc_token); // Should panic
}
